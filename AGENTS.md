...
- Treat `this-is-what-i-want.txt` as the source of truth for what the daily edition should try to show, emphasize, and avoid whenever scan content is being produced.
